...
public class data extends JFrame {
	...
	public data() {
		...
		/**
		 * Inicia la programaci�n para conectar la JTable con la base de datos "dinero" para mostrar la informaci�n en la tabla
		 */
		Vector columnNames = new Vector();
		Vector data = new Vector();
		try {
            con = DriverManager.getConnection("jdbc:mysql://" + "localhost"
                    + ":3306/mydb", "root", "uvg"); //Se conecta a la base de datos (cambiar contrase�a en las ultimas comillas)
		...
		/**
		 * Finaliza la programaci�n para crear la tabla que contiene la informaci�n de la base de datos "dinero"
		 */
		...
		/**
		 * A�ade en los campos requeridos de la tabla los datos de la base de Datos
		 */
